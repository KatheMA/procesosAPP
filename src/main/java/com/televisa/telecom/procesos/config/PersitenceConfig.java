package com.televisa.telecom.procesos.config;
...
@Configuration
@EnableJpaRepositories(basePackages="com.televisa.telecom.procesos.repository",transactionManagerRef="transactionManager")
...
public class PersitenceConfig 
{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
	{
		...
		factory.setPackagesToScan(new String[]{"com.televisa.telecom.procesos.persistence"});
